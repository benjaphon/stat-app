...
<div class="row">
    <div class="col-lg-12">
        <div class="form-group">
            <a class="btn btn-lg btn-success btn-xs-block" href="<?php echo $baseUrl; ?>/back/graph/create">
...
$(document).ready(function() {
    ...
    $('#btn_edit').click( function () {
        ...
        window.location.replace("<?php echo $baseUrl; ?>/back/graph/update/" + id);
    } );
    ...
    $('#btn_delete').click( function () {
        ...
        function(){
            ...
            $.get("<?php echo $baseUrl; ?>/back/graph/form-delete-subject/" + id);
