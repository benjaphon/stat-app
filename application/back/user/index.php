...
$search_arr = array();
$search_arr[] = isset($_GET['User_username']) && !empty($_GET['User_username']) ? "username like '%" . $_GET['User_username'] . "%'" : "1=1";
$search_arr[] = isset($_GET['User_firstname']) && !empty($_GET['User_firstname']) ? "firstname like '%" . $_GET['User_firstname'] . "%'" : "1=1";
$search_arr[] = isset($_GET['User_lastname']) && !empty($_GET['User_lastname']) ? "lastname like '%" . $_GET['User_lastname'] . "%'" : "1=1";
$search_arr[] = isset($_GET['User_user_type']) && !empty($_GET['User_user_type']) && $_GET['User_user_type'] != "all" ? "user_type = '" . $_GET['User_user_type'] . "'" : "1=1";
            ...
            <div class="search-form" style="display:none">
                ...
                <form id="yw0" action="<?php echo $baseUrl; ?>/back/user/index" method="get"><div class="form-horizontal" style="margin-top: 10px;">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <input size="50" maxlength="50" class="form-control input-sm" name="User_username" id="User_username" type="text" />        </div>
                        </div>

                        <div class="form-group">
                            <label for="Username" class="col-sm-2 control-label">ชื่อจริง</label>
                            <div class="col-sm-4">
                                <input size="60" maxlength="100" class="form-control input-sm" name="User_firstname" id="User_firstname" type="text" />        </div>
                        </div>

                        <div class="form-group">
                            <label for="Username" class="col-sm-2 control-label">นามสกุล</label>
                            <div class="col-sm-4">
                                <input size="60" maxlength="100" class="form-control input-sm" name="User_lastname" id="User_lastname" type="text" />        </div>
                        </div>

                        <div class="form-group">
                            <label for="Username" class="col-sm-2 control-label">ประเภท</label>
                            <div class="col-sm-4">
                                <select class="form-control input-sm" name="User_user_type" id="User_user_type">
